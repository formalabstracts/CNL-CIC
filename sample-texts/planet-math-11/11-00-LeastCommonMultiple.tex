...
\dfn{
Assume that $f,\ p,\ q$ are integers. Then we say $f$ is a \df{common multiple} of $p$ and $q$ iff $p$
  divides $f$ and $q$ divides $f$.}
...
\dfn{Assume that $p,\ q, \ f$ are positive integers. Then we say that $f$ is a \df{least common multiple} of $p$ and $q$  
iff $f$ is a positive common multiple of $p$ and $q$ such that 
for every common multiple $r$ of $p$ and $q$ we have $\natdiv{f}{r}$.}

\dfn{ Assume that  $p,\ q$ are positive integers. Let $\h{\df{lcm}}\ p\ q$ denote the least common multiple of
