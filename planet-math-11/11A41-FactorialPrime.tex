...
is a \df{prime} iff each positive divisor of $p$ is either equal to $1$ or equal to $p$.
}
...
is a \df{factorial prime} iff there exists a natural number $n$ such that $p$ is equal to $\factorial {n}+ 1 $ or $p$ equal to $\factorial {n} - 1 $.
}
