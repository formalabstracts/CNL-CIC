...
\deflabel{divides}
We say $d$ \df{divides} $m$ iff $d\ne 0$ and there exists $r$ such that $m= d\*r$.
\end{definition}
...
\deflabel{common divisor}
 We say $d$ is a \df{common divisor} of $p$ and $q$  iff $d$ divides $p$  and $d$ divides $q$. 
\end{definition}
...
We say $d$ is a \df{greatest common divisor} of $p$ and $q$  
iff $d$ is a common divisor of $p$ and $q$ such that 
for every common divisor $r$ of $p$ and $q$ we have $r\le d$.
\end{definition}

\deflabel{gcd notation}
Assume $p,\ q$ are integers.  Then let $\h{\df{gcd}}\ p\ q$ be the greatest common divisor of $p$ and $q$. This exists and is unique. 
\end{definition}
