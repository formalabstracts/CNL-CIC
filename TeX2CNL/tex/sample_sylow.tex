...
%- macro
We say that $\alpha$ is a \df{\prefix{type~}{finite}} type iff the
universe of $\alpha$ is finite.

\begin{definition}
Assume that $\alpha$ is a \prefix{type~}{finite} type.  The
\df{\prefix{type~}{size}} of $\alpha$ is the size of the universe of
$\alpha$.  This exists and is unique.
\end{definition}

\begin{definition}
Assume that $\alpha$ is a finite type.  The \df{\prefix{type~}{support}}
...
we record a canonical isomorphism $f : F \to G \assign$ 
