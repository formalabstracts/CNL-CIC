...
\subsection{pdf} The pdf generated from this text is 
...
\subsection{CNL}  Here is the generated CNL.  (We have cleaned up the white space.)
...
Definition  Label_least_element  .    We  say  that    y    is  a  
leastelement  in  R    iff  for  all    x  ,  y  \le x    .  
    
Let    x  <  y    stand  for    x  \le y    and    x  \ne y    .  
  
Definition  Label_maximal_element  .    We  say  that    y    is  a  
maximalelement  in    R    iff  there  exists  no    x    such  that    y  <  x    .  
\end{verbatim}

\subsection{parse tree}  This has been generated by hand.
